    <?php
    $email_destinataire = 'mpinson.pro@gmail.com';
    ...
    else
    {
        ...
        if (($nom != '') && ($prenom != '') && ($email != '') && ($objet != '') && ($message != ''))
        {
            ...
            if ($copie == 'oui')
            {
                $cible = $email_destinataire.';'.$email;
            }
            else
            {
                $cible = $email_destinataire;
            };
            ...
            $num_emails = 0;
            $tmp = explode(';', $cible);
            foreach($tmp as $email_destinataires)
            {
                if (mail($email_destinataires, $objet, $message, $headers))
                    $num_emails++;
            }
